   ...
   <?php include_once('includes/header.php');?>
    ...
    <div class="content">
        <div class="container">
            ...
            <p>Experience the royal treatment at a price you'll love</p>
          </div>
               <table class="table table-bordered"> <thead> <tr> <th>Number</th> <th>Service Name</th> <th>Service Price</th> <th>Service Description</th> </tr> </thead> <tbody>
<?php
...
?>
             ...
             <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['ServiceName'];?></td> <td>Rs:<?php  echo $row['Cost'];?>.00</td> <td><?php  echo $row['Description'];?></td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
